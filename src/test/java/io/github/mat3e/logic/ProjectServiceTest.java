...
class ProjectServiceTest {
    ...
    void createGroup_configurationOk_And_noProject_throwsArgumentException() {
        // given
    ...
    void createGroup_noMultipleGroupsConfig_And_noUndoneGroupExists_noProjects_throwsArgumentException() {
        // given
        var mockRepository = mock(ProjectRepository.class);
        when(mockRepository.findById(anyInt())).thenReturn(Optional.empty());
        // and
    ...
    private TaskConfigurationProperties configuratrionReturning(final boolean result) {
